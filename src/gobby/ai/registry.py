...
def build_daemon_ai_capability_registry(
    ...
    *,
    ...
    from gobby.ai.registry_builder import (
        build_daemon_ai_capability_registry as build_registry,
    )

    return build_registry(
        config,
        provider_installed=provider_installed,
        whisper_runtime_available=_whisper_runtime_available,
        provider_install_probe_ttl_seconds=PROVIDER_INSTALL_PROBE_TTL_SECONDS,
    )
