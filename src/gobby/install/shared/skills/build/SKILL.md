...
## E2E Validation And Debugging

Interactive E2E validation and automation-debugging methodology live in the
`build-coordinator` skill. Load it when validating an unattended build run or
debugging stalled automation; this wizard only launches builds.
