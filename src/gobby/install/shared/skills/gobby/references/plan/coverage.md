...
- Acceptance IDs append `.<n>` to the exact section ID; numeric sections never gain a synthetic A. Each item names a file, symbol, test, or behavior artifact. Work-enumerating tables need one acceptance item per data row.
