...
When the adaptation feels native to each context, call `get_skill_file(name="impeccable", path="references/polish.md")` on `gobby-skills` and follow it for the final pass.
