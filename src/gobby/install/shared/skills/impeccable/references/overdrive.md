...
2. **Ask the user** (use the structured question tool when available) to present these directions and get the user's pick before writing any code. Explain trade-offs (browser support, performance cost, complexity).
