...
Auto-select 2-3 personas most relevant to this interface type (use the selection table in the reference). If `.impeccable.md` contains a `## Design Context` section (written by `impeccable teach`), also generate 1-2 project-specific personas from the audience/brand info.
...
If `.impeccable.md` contains a `## Design Context` section (written by `impeccable teach`), derive 1–2 additional personas from the audience and brand information:
