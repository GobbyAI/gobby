...
| `memory-lifecycle` | `memory-lifecycle/` | 10 | Shadow relevance judging, initial-load recovery, reminders, claim-time search nudge, turn-start memory surfacing, post-close review, plan-memory guards, turn sequencing, and tracking reset |
