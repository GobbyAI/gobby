...
| `memory-lifecycle` | `memory-lifecycle/` | 12 | Digest, layered guidance, claim-time search nudge, post-close review, plan-memory guards, turn sequencing, and tracking reset |
