...
| `memory-lifecycle` | `memory-lifecycle/` | 12 | Shadow relevance judging, initial-load recovery, reminders, tool-intent memory surfacing at agent spawn, task claim, and handoff, post-close review, plan-memory guards, turn sequencing, and tracking reset |
