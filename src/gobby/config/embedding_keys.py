...
EMBEDDING_CATALOG_KEY_FIELD = "catalog_key"
...
EMBEDDING_SWITCH_COMPLETED_KEY = f"{AI_EMBEDDINGS_CONFIG_PREFIX}.completed_switch"
EMBEDDING_INTERNAL_LIFECYCLE_KEYS = frozenset(
