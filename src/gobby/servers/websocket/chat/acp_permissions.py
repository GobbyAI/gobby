"""Tool approval and plan-mode helpers for ACP web-chat sessions."""
...
class ACPWebChatPermissionsMixin:
    """Permission and plan helpers for ACP web-chat wrappers."""
...
__all__ = ["ACPWebChatPermissionsMixin"]
