"""Daemon configuration YAML import and export routes."""
...
def register_import_export_routes(
    ...
    """Register daemon YAML import and export aliases."""
    ...
    @router.post("/import")
    async def import_config(request: ConfigDocumentRequest) -> JSONResponse:
        try:
...
__all__ = ["register_import_export_routes"]
