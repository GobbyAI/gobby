...
class Session:
    ...
    wiki_synthesis_consecutive_failures: int = 0
    wiki_synthesis_last_failure_reason: str | None = None
    wiki_synthesis_last_error: str | None = None
    wiki_synthesis_last_failed_at: str | None = None
    ...
    def from_row(cls, row: Mapping[str, Any]) -> Session:
        ...
        return cls(
            ...
            wiki_synthesis_consecutive_failures=(
                row["wiki_synthesis_consecutive_failures"] or 0
                if "wiki_synthesis_consecutive_failures" in row.keys()
                else 0
            ),
            wiki_synthesis_last_failure_reason=cls._get_optional(
                row, "wiki_synthesis_last_failure_reason"
            ),
            wiki_synthesis_last_error=cls._get_optional(row, "wiki_synthesis_last_error"),
            wiki_synthesis_last_failed_at=cls._get_optional(row, "wiki_synthesis_last_failed_at"),
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "wiki_synthesis_consecutive_failures": self.wiki_synthesis_consecutive_failures,
            "wiki_synthesis_last_failure_reason": self.wiki_synthesis_last_failure_reason,
            "wiki_synthesis_last_error": self.wiki_synthesis_last_error,
            "wiki_synthesis_last_failed_at": self.wiki_synthesis_last_failed_at,
