...
def test_draft_preserves_executor_context_and_atomicity() -> None:
    ...
    for term in (
        ...
        "shared 10,000 JSON-escaped character cap",
        "surface the preservation conflict before initiating compaction",
        "never truncate the draft or repeatedly submit oversized content",
