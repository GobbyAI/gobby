...
SKILL_PATH = REPO_ROOT / "src/gobby/install/shared/skills/qa/SKILL.md"
...
def test_id_opt_in_present() -> None:
    ...
    assert "src/gobby/install/shared/workflows/qa.yaml" in body
