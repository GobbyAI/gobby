...
from gobby.storage.task_affected_files import AnnotationSource, TaskAffectedFile
...
def _make_af(task_id: str, file_path: str, source: AnnotationSource = "manual") -> TaskAffectedFile:
...
class TestSetAffectedFiles:
    def test_set_files_success(self, ctx: MagicMock, mock_resolve: None) -> None:
    ...
    def test_set_files_invalid_task(self, ctx: MagicMock) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
...
class TestGetAffectedFiles:
    def test_get_files_success(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
    ...
    def test_get_files_empty(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
...
class TestFindFileOverlaps:
    def test_find_overlaps_success(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
        ...
        with patch(
            ...
            assert find_overlaps is not None
    ...
    def test_find_overlaps_none(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
    ...
    def test_find_overlaps_invalid_task(self, ctx: MagicMock) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
        from gobby.storage.tasks import TaskNotFoundError
...
class TestWireAffectedFilesFromRun:
    def test_wire_success(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
    ...
    def test_wire_skips_tasks_without_files(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
    ...
    def test_wire_errors_when_run_missing(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
    ...
    def test_wire_errors_when_compiled_spec_missing(
        self, ctx: MagicMock, mock_resolve: None
    ) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
    ...
    def test_wire_errors_when_task_map_missing(self, ctx: MagicMock, mock_resolve: None) -> None:
        from gobby.mcp_proxy.tools.tasks._affected_files import create_ops_affected_files_registry
