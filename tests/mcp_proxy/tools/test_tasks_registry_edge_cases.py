...
class TestSessionIntegrationTools:
    ...
    def _set_session_context(self) -> Generator[None]:
...
class TestRegistryIntegration:
    ...
    def test_registry_name_and_description(self, task_registry: Any) -> None:
    ...
    def test_crud_tools_registered(self, task_registry: Any) -> None:
    ...
    def test_label_tools_registered(self, task_registry: Any) -> None:
    ...
    def test_session_tools_registered(self, task_registry: Any) -> None:
    ...
    def test_reopen_task_registered(self, task_registry: Any) -> None:
    ...
    def test_set_task_type_defaults_rejects_invalid_payload(self, task_registry: Any) -> None:
        ...
        assert result == {
            ...
            "message": "stages[0].stage_name must be a non-empty string",
        }

    def test_merged_registries_available(self, task_registry: Any) -> None:
