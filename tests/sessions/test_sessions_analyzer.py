...
class TestFormatToolDescription:
    ...
    def test_mcp_call_tool_close_task_preview_is_described_as_readiness_check(self) -> None:
        analyzer = TranscriptAnalyzer(get_parser("claude"))
        block = {
            "name": "mcp__gobby__call_tool",
            "input": {
        ...
        assert analyzer._format_tool_description(block) == "Previewed close readiness for task #789"
