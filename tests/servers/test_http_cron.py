...
class TestCronCreateJob:
    ...
    def test_create_job_surfaces_invalid_cron_expression(
        self, client, cron_storage, project_storage: LocalProjectManager
    ) -> None:
        project = project_storage.create(name="invalid-cron-project")
