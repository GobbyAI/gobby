...
const distFirewallPath = join(distSetup, "setup-firewall.sh");
...
cpSync(firewallScriptPath, distFirewallPath);
...
const pkgJson = {
  ...
  engines: { node: ">=18" },
  files: ["cli.mjs", "setup-firewall.sh"],
...
console.log(`  script: ${distFirewallPath}`);
