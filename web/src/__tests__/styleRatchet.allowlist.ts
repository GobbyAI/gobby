...
export const BTN_CLASS_ALLOWLIST: Record<string, number> = {
  ...
  'src/components/activity/ActivityActionsContext.tsx': 6,
  'src/components/activity/ActivityFilterFooter.tsx': 6,
  'src/components/activity/ActivityPanel.tsx': 6,
  'src/components/activity/AgentsTab.tsx': 3,
  'src/components/activity/FilesTab.tsx': 9,
  'src/components/activity/IntegrationsTab.tsx': 3,
  'src/components/activity/MemoryTab.tsx': 6,
  'src/components/activity/PipelinesTab.tsx': 3,
  'src/components/activity/RulesTab.tsx': 6,
  'src/components/activity/SessionsTabDetail.tsx': 9,
  'src/components/activity/SessionsTabList.tsx': 3,
  'src/components/activity/StagesTab.tsx': 3,
  'src/components/activity/TaskCloseDialog.tsx': 6,
  'src/components/activity/TasksTabToolbar.tsx': 3,
  'src/components/activity/integrations/IntegrationsTabToolbar.tsx': 3,
  'src/components/activity/integrations/MessagesView.tsx': 3,
  'src/components/activity/mcp/McpDetailPanel.tsx': 3,
  'src/components/activity/memory/MemoryDetailPanel.tsx': 3,
  'src/components/activity/skills/SkillsHubDetail.tsx': 6,
  'src/components/activity/skills/SkillsHubView.tsx': 2,
  'src/components/activity/taskdetail/TaskDetailStatusLine.tsx': 3,
  'src/components/chat/AgentStatusBar.tsx': 15,
  'src/components/chat/CommandBar.tsx': 3,
  'src/components/settings/SettingsOverlay.tsx': 4,
  'src/components/settings/WorkflowVariablesEditor.tsx': 12,
  'src/components/settings/fields/KeyValueMapField.tsx': 6,
  'src/components/settings/fields/StringListField.tsx': 6,
  'src/components/settings/fields/TypedListField.tsx': 6,
  'src/components/settings/sections/McpToolsSection.tsx': 6,
  'src/components/settings/sections/SecretsAuthSection.tsx': 6,
}
...
export const RAW_ELEMENT_ALLOWLIST: Record<RawElement, Record<string, number>> = {
  button: {
    ...
    'src/components/activity/ActivityActionsContext.tsx': 2,
    'src/components/activity/ActivityFilterDropdown.tsx': 1,
    'src/components/activity/ActivityFilterFooter.tsx': 2,
    'src/components/activity/ActivityMcpTab.tsx': 4,
    'src/components/activity/ActivityPanel.tsx': 4,
    'src/components/activity/AgentsTab.tsx': 1,
    'src/components/activity/CronTab.tsx': 2,
    'src/components/activity/FileChangesTab.tsx': 2,
    'src/components/activity/FilesTab.tsx': 12,
    'src/components/activity/IntegrationsTab.tsx': 2,
    'src/components/activity/MemoryTab.tsx': 3,
    'src/components/activity/PipelinesTab.tsx': 4,
    'src/components/activity/PlanReviewCard.tsx': 1,
    'src/components/activity/QuickMenu.tsx': 2,
    'src/components/activity/RulesTab.tsx': 3,
    ...
    'src/components/activity/SessionsTabDetail.tsx': 4,
    'src/components/activity/SessionsTabList.tsx': 2,
    'src/components/activity/SkillsTab.tsx': 1,
    'src/components/activity/StagesTab.tsx': 2,
    'src/components/activity/TaskCloseDialog.tsx': 2,
    ...
    'src/components/activity/TasksTabToolbar.tsx': 1,
    ...
    'src/components/activity/fields/FieldPrimitives.tsx': 2,
    ...
    'src/components/activity/integrations/IntegrationsTabToolbar.tsx': 1,
    'src/components/activity/integrations/MessagesView.tsx': 1,
    'src/components/activity/mcp/McpDetailPanel.tsx': 1,
    'src/components/activity/memory/KnowledgeGraph.tsx': 5,
    'src/components/activity/memory/MemoryDetailPanel.tsx': 2,
    ...
    'src/components/activity/skills/SkillsHubDetail.tsx': 2,
    'src/components/activity/skills/SkillsHubView.tsx': 2,
    ...
    'src/components/activity/taskdetail/TaskDetailStatusLine.tsx': 1,
    ...
    'src/components/settings/SettingsOverlay.tsx': 3,
    'src/components/settings/WorkflowVariablesEditor.tsx': 4,
    'src/components/settings/fields/KeyValueMapField.tsx': 2,
    'src/components/settings/fields/StringListField.tsx': 2,
    'src/components/settings/fields/TypedListField.tsx': 2,
    'src/components/settings/sections/McpToolsSection.tsx': 2,
    'src/components/settings/sections/PromptsTemplatesSection.tsx': 1,
    'src/components/settings/sections/SecretsAuthSection.tsx': 2,
  ...
  select: {
    ...
    'src/components/activity/integrations/IntegrationsTabToolbar.tsx': 2,
    'src/components/activity/pipelines/PipelineStepList.tsx': 1,
    'src/components/activity/skills/SkillsHubView.tsx': 1,
...
export const CSS_TOTAL_LINE_CEILING = 7493
