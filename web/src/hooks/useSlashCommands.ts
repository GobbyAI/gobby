...
export const COMMANDS: CommandInfo[] = [
  {
    name: "act",
    description: "Switch from plan mode to act mode",
    action: "exit_plan_mode",
  },
  {
    name: "chat",
    description: "Show or hide the chat pane",
    action: "toggle_chat",
  },
  ...
  {
    name: "gobby",
    description: "Browse internal Gobby tools",
    action: "open_gobby",
  },
  { name: "mcp", description: "Open MCP activity", action: "open_mcp" },
  {
    name: "panel",
    description: "Show or hide the activity panel",
    action: "toggle_panel",
  },
  {
    name: "plan",
    description: "Enter plan mode or show plan",
    action: "show_plan",
  },
  {
    name: "restart",
