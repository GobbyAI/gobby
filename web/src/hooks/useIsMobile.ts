...
export function mobileTierQuery(): string {
  ...
  const maxWidth = readPixelToken(
    styles,
    MOBILE_MAX_WIDTH_TOKEN,
    DEFAULT_MOBILE_MAX_WIDTH,
  );
  const maxHeight = readPixelToken(
    styles,
    MOBILE_MAX_HEIGHT_TOKEN,
