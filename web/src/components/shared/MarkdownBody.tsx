...
const unclosedBlockProtocolTagPattern = buildTagPattern(
  UNCLOSED_BLOCK_PROTOCOL_TAGS,
);
const wrapperOnlyProtocolTagPattern = buildTagPattern(
  WRAPPER_ONLY_PROTOCOL_TAGS,
);
...
export function MarkdownBody({
  ...
  const mergedComponents = useMemo<Partial<Components>>(
    () =>
      components
        ? { ...codeBlockComponents, ...components }
        : codeBlockComponents,
    [components],
  );
