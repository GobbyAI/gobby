...
function makeFields(overrides: Partial<SettingsSectionFields> = {}): SettingsSectionFields {
...
describe('configuration field activation', () => {
  ...
  it('routes_managed_keys_and_shows_failed_live_status', () => {
    ...
    expect(screen.getByText('Live apply failed in memory-runtime at revision 12')).toBeInTheDocument()
