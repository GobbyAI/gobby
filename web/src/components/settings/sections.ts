...
export const SETTINGS_SECTIONS = [
  ...
  },
  {
    ...
    label: "Chat & Voice",
    description:
      "Default chat mode, voice preferences, and STT/TTS daemon settings.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Tasks, workflows, cron, pipelines, tmux automation, and variables.",
  },
  {
    id: "mcp-tools",
    label: "MCP & Tools",
    description:
      "MCP proxy, tool search and recommendation, and skills hub configuration.",
  },
  {
    id: "memory-knowledge",
