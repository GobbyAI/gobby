...
describe('ActivityRowStatusDot — deutan-safe state rendering (#14586)', () => {
  ...
  it('paints a distinct lucide glyph for each kind', () => {
    ...
    // Five kinds, five distinct lucide icons — uniqueness is the guard
