...
function DirectionIcon({ direction }: { direction: CommsMessage["direction"] }) {
      ...
      <DetailPaneHeader
        title={
          <div className="flex min-w-0 items-center gap-2">
            ...
            <h2 className="m-0 truncate text-sm font-medium text-foreground">Messages</h2>
        ...
        onSave={() => undefined}
        onDiscard={() => undefined}
        actions={<DetailActionButton label="Close messages" onClick={onClose} />}
      />
