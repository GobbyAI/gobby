...
export const AGENT_BTN_CLS =
  "px-3 py-1 border border-border rounded-md bg-[var(--bg-tertiary)] text-[var(--text-primary)] text-sm font-medium cursor-pointer transition-colors hover:bg-[var(--bg-secondary)] hover:border-[var(--text-muted)] disabled:opacity-50 disabled:cursor-not-allowed pointer-coarse:min-h-11";
...
export const AGENT_EDIT_LABEL_CLS =
  "text-xs text-[var(--text-muted)] uppercase tracking-[0.3px]";
...
export const AGENT_EDIT_INPUT_CLS =
  "bg-[var(--bg-primary)] border border-border rounded-md px-2.5 py-1.5 text-md text-[var(--text-primary)] font-[inherit] outline-none transition-colors focus:border-[var(--accent)] focus:shadow-[0_0_0_2px_color-mix(in_srgb,var(--accent)_20%,transparent)]";
...
export const AGENT_EDIT_MODEL_TOGGLE_CLS =
  "bg-transparent border border-border rounded text-[var(--text-muted)] cursor-pointer px-1.5 py-1 text-base leading-none transition-colors hover:bg-[var(--bg-tertiary)] hover:text-[var(--text-primary)] pointer-coarse:min-h-11";
...
export const AGENT_EDIT_LINK_BTN_CLS =
  "bg-transparent border-0 text-[var(--accent)] underline cursor-pointer text-sm p-0 hover:text-[var(--accent-hover)]";
...
export const AGENT_EDIT_CHECKBOX_CLS =
  "flex items-center gap-1.5 cursor-pointer text-md text-[var(--text-primary)] select-none";
...
export const AGENT_RULES_CHIP_CLS =
  "inline-flex items-center gap-1 bg-[var(--bg-tertiary)] border border-border rounded-xl pl-2.5 pr-2 py-0.5 text-sm text-[var(--text-primary)]";
export const AGENT_RULES_CHIP_REMOVE_CLS =
  "bg-none border-0 text-[var(--text-muted)] cursor-pointer text-base leading-none px-0.5 transition-colors hover:text-[var(--color-error)]";
...
export const AGENT_RULES_EMPTY_CLS =
  "text-sm text-[var(--text-muted)] italic";
...
export const AGENT_RULE_SELECTOR_HEADING_CLS =
  "text-xs text-[var(--text-muted)] uppercase tracking-wider";
...
export const AGENT_VARS_ADD_INPUT_CLS = `${AGENT_EDIT_INPUT_CLS} flex-1 min-w-0 text-sm px-2 py-1`;

// ── Card grid / cards ──

export const AGENT_DEFS_EMPTY_CLS =
  "text-center p-10 text-[var(--text-muted)] text-sm";
...
export const AGENT_DEF_NAME_CLS =
  "font-semibold text-base text-[var(--text-primary)] font-sans";
export const AGENT_DEF_CHEVRON_CLS =
  "text-[var(--text-muted)] text-2xs";
export const AGENT_DEF_DESC_CLS =
  "text-sm text-[var(--text-muted)] leading-tight overflow-hidden text-ellipsis whitespace-nowrap";

export const AGENT_DEF_BADGES_CLS = "flex flex-wrap gap-[5px] mt-0.5";

export const AGENT_DEF_BADGE_CLS =
  "text-2xs px-[7px] py-px rounded-[10px] border border-current font-medium whitespace-nowrap";
...
export const AGENT_DEF_PROP_ROW_CLS =
  "flex justify-between items-center text-sm py-[3px]";
export const AGENT_DEF_PROP_LABEL_CLS = "text-[var(--text-muted)]";
export const AGENT_DEF_PROP_VALUE_CLS =
  "font-[inherit] font-medium text-[var(--text-primary)] text-sm";
...
export const STEP_NAME_BADGE_CLS =
  "font-[inherit] text-sm font-semibold text-[var(--accent)] bg-[color-mix(in_srgb,var(--accent)_10%,transparent)] px-2 py-px rounded-[10px] whitespace-nowrap";
export const STEP_PREVIEW_CLS =
  "flex-1 text-sm text-[var(--text-muted)] overflow-hidden text-ellipsis whitespace-nowrap";
export const STEP_CHEVRON_CLS =
  "text-[var(--text-muted)] text-2xs shrink-0";
...
export const STEP_FIELD_LABEL_CLS =
  "text-xs text-[var(--text-muted)] uppercase tracking-[0.3px] flex items-center gap-2";

export const STEP_SECTION_CLS =
  "flex flex-col gap-1.5 pt-1.5 border-t border-border";
export const STEP_SECTION_LABEL_CLS =
  "text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider m-0";

export const STEP_TOGGLE_SELECT_CLS =
  "text-xs! px-1 py-px! w-auto! max-w-[80px]";
...
export const STEP_CHIP_CLS =
  "inline-flex items-center gap-[3px] bg-[var(--bg-tertiary)] border border-border rounded-[10px] pl-2 pr-1.5 py-px text-xs font-[inherit] text-[var(--text-primary)]";
export const STEP_CHIP_REMOVE_CLS =
  "bg-none border-0 text-[var(--text-muted)] cursor-pointer text-md leading-none px-px hover:text-[var(--color-error)]";
export const STEP_CHIP_ADD_ROW_CLS = "flex gap-1 items-center";
export const STEP_CHIP_FIELD_CLS =
  "flex-1 min-w-0 text-sm! px-2 py-[3px]!";
...
export const STEP_TRANSITION_TO_CLS =
  "w-[120px] shrink-0 text-sm! px-1.5 py-1!";
export const STEP_TRANSITION_WHEN_CLS =
  "flex-1 min-w-0 text-sm! px-1.5 py-1! font-[inherit]";

export const STEP_ADVANCED_TOGGLE_CLS =
  "bg-none border-0 text-[var(--text-muted)] text-sm cursor-pointer flex items-center gap-1 p-0 uppercase tracking-wider font-medium hover:text-[var(--text-primary)]";
export const STEP_ADVANCED_FIELDS_CLS =
  "flex flex-col gap-2 mt-1.5";

export const STEP_JSON_EDITOR_CLS =
  "font-[inherit]! text-xs! min-h-[60px]";
