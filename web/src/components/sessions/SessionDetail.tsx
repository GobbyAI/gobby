...
const REGENERATE_BTN_CLS = [
  'ml-auto flex cursor-pointer items-center rounded border border-[var(--border)]',
  'bg-transparent p-1 text-[var(--text-muted)] transition-[color,border-color] duration-150',
