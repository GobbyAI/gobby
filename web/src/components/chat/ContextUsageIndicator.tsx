...
export function ContextUsageIndicator({
  ...
  if (contextWindow) {
    tooltipLines.push(
      `Context: ${formatTokens(totalInputTokens)} / ${formatTokens(contextWindow)} tokens (${displayPercent}%)`,
    );
    tooltipLines.push("");
  ...
  return (
    <div
      className="flex items-center gap-1.5 text-[length:var(--text-sm)] font-medium text-[var(--text-secondary)]"
