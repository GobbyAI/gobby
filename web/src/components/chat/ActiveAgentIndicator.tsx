  ...
  return (
    <>
      <button
        ...
        title={disabled ? `Attached session owns active persona: ${agentName}` : `Active persona: ${agentName}`}
        aria-label={disabled ? `Attached session owns active persona: ${agentName}` : `Active persona: ${agentName}`}
        disabled={disabled}
      >
