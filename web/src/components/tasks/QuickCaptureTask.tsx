      ...
      >
        ...
        <form className="flex flex-col gap-[10px]" onSubmit={handleSubmit}>
          <Input
            ref={inputRef}
            type="text"
            className="box-border h-auto rounded-lg bg-[var(--bg-primary)] py-[10px] text-[length:var(--text-base)] font-[var(--font-sans)] text-[var(--text-primary)] placeholder:text-[var(--text-muted)]"
            value={title}
          ...
          {error && (
            <p
              className="text-[length:var(--text-sm)] text-[var(--color-error)]"
              role="alert"
            >
              {error}
            </p>
          ...
          <div className="text-center text-[length:var(--text-xs)] text-[var(--text-muted)]">
            <kbd className="inline-block rounded-[3px] border border-[var(--border)] bg-[var(--bg-tertiary)] px-[5px] py-[1px] font-[inherit] text-[length:var(--text-2xs)]">
              Enter
            </kbd>{" "}
            to create &middot;{" "}
            <kbd className="inline-block rounded-[3px] border border-[var(--border)] bg-[var(--bg-tertiary)] px-[5px] py-[1px] font-[inherit] text-[length:var(--text-2xs)]">
