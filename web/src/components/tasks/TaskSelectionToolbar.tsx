...
const BTN_BASE_CLS =
  'flex cursor-pointer items-center gap-[0.3rem] min-h-11 rounded-md border border-[var(--border)] px-3 py-[0.4rem] font-[inherit] text-[length:calc(var(--font-size-base)*0.8)] font-medium transition-all duration-150'
