...
export const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md border font-medium whitespace-nowrap transition-colors select-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        // Bordered, transparent — the default for ordinary action buttons.
        secondary:
          "border-border bg-transparent text-muted-foreground hover:border-foreground-muted hover:bg-muted hover:text-foreground",
        ...
        accent:
          "border-[color-mix(in_srgb,var(--accent)_35%,transparent)] bg-accent-tint text-accent hover:border-[color-mix(in_srgb,var(--accent)_55%,transparent)] hover:bg-accent-soft",
