...
export function TabBar({
  ...
  return (
    <div
      className={cn(
        "mb-3 [scrollbar-width:none] overflow-x-auto overflow-y-hidden [&::-webkit-scrollbar]:hidden",
        className,
      )}
    >
      <div
          ...
          return (
            ...
            >
              <button
                ...
                className={cn(
                  coarseHitAreaCls,
                  "inline-flex shrink-0 cursor-pointer items-center gap-1.5 border-0 bg-transparent px-4 py-2 text-[length:var(--text-sm)] font-medium whitespace-nowrap text-[var(--text-secondary)] transition-colors duration-150",
