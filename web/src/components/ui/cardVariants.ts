...
export const cardVariants = cva('rounded-lg border border-border bg-background', {
  variants: {
    padding: {
      none: '',
      sm: 'p-3',
    ...
    interactive: {
      true: 'cursor-pointer text-left transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background',
      false: '',
    },
  },
  defaultVariants: {
