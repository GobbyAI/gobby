...
Targets:
- `tests/workflows/test_memory_recall_helper_ordering.py` (extend with the four integration tests — same file as §3.2.4 / §3.4.4, new top-level test functions).
...
Four integration tests cover the cross-rule behavior:
