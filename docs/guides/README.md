...
| [gclient-user-guide.md](gclient-user-guide.md) | `gclient` terminal workspace: layout, daemon-owned workspaces and refs, keybindings and host/pane keyboard protocols, control leases, mouse, and reconnects |
