...
| `_gobby_feedback_epoch_reviewed` | `false` | bool | Persisted epoch ack for the bundled Gobby-experience survey; set true when the gate fires or `gobby-sessions:feedback` succeeds |
