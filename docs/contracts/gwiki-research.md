...
The canonical `gwiki research` contract lives in the in-repo Rust workspace
under `crates/gwiki`. Gobby consumes that contract as an enhancer,
...
`--agent-count`, or `--resume` is retired by the gwiki contract.

Reference commits:

- Spec: historical `gobby-cli@6b5c5ba8660624438d7416b412ec94ff86dec9a2`.
- First implementation slice:
  historical `gobby-cli@f9bbde3fb836cac1bf99047558d5d2cca869310b`.
