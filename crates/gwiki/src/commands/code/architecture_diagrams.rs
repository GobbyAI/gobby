...
mod tests {
    ...
    use super::*;
    use crate::commands::code::render::{
        render_module_call_sequence, render_module_dependency_mermaid,
    };
    use crate::commands::code::system_model::{Crate, ServiceBoundary};
    use crate::commands::code::types::{CodewikiGraphAvailability, CodewikiGraphEdge, FileDoc};
