...
pub use qdrant::{
    ...
    delete_code_symbol_collections_with_prefix, delete_exact_collection, delete_file_vectors,
    delete_project_collection, list_code_symbol_collections, vector_search,
};
