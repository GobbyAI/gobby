-- Replace live interactive issuers after 383 without rewriting applied receipts.
-- Role names hash the full token/machine/project triple; input is validated
-- before the advisory lock. Rotate uses the same construction.
