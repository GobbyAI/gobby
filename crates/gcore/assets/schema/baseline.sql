...
-- baseline@419: flattened from baseline@375 + migrations 376-418.
...
-- flattened migration 376_copy_agent_definitions.sql
...
-- flattened migration 377_copy_agent_step_instances.sql
...
-- flattened migration 378_copy_rule_definitions.sql
...
-- flattened migration 379_copy_session_variable_defaults.sql
...
-- flattened migration 380_copy_pipeline_definitions.sql
...
-- flattened migration 381_drop_legacy_workflow_tables.sql: destructive; fresh lineages receipt-stamp it without executing.

-- flattened migration 382_grant_gwiki_tables_to_capability.sql
...
-- flattened migration 383_refresh_reused_interactive_principal.sql
...
-- flattened migration 384_grant_projects_liveness_to_capability.sql
-- Wiki writer locks run `SELECT deleted_at IS NULL FROM projects`.
GRANT SELECT (deleted_at) ON TABLE projects TO gobby_gcode_capability;

-- flattened migration 385_issue_maintenance_principal.sql
...
-- flattened migration 386_interactive_principal_role_hash.sql
...
-- flattened migration 387_interactive_principal_role_helper.sql
...
-- flattened migration 388_grant_interactive_role_name.sql
...
-- flattened migration 389_sweep_interactive_orphan_roles.sql
...
-- flattened migration 390_retain_interactive_credential_material.sql
...
-- flattened migration 391_session_last_activity_and_creation_defaults.sql
...
-- flattened migration 392_chat_attachments_deletion_lease.sql
...
-- flattened migration 393_interactive_principal_hardening.sql
...
-- flattened migration 394_sessions_status_last_activity_index.sql
...
-- flattened migration 395_code_inheritance.sql
...
-- flattened migration 396_memory_rationale_and_provenance.sql
...
-- flattened migration 397_memories_source_task_index.sql
-- Memory source_task index must not run inside a transaction.
CREATE INDEX IF NOT EXISTS idx_memories_source_task ON memories USING btree (source_task_id);

-- flattened migration 398_code_indexed_project_states_indexer_version.sql
ALTER TABLE code_indexed_project_states
ADD COLUMN IF NOT EXISTS indexer_version text;

-- flattened migration 399_drain_orphan_binding_alias.sql
...
-- flattened migration 400_drop_vision_extract_config_rows.sql
...
-- flattened migration 401_model_metadata_reasoning.sql
...
-- flattened migration 402_task_close_reviews.sql
...
-- flattened migration 403_interactive_overlay_principal.sql
...
-- flattened migration 404_scope_rotation_sweep_to_managed_principals.sql
...
-- flattened migration 405_maintenance_overlay_principal.sql
...
-- flattened migration 406_interactive_generation_roll.sql
...
-- flattened migration 407_interactive_session_id_nullable.sql
...
-- flattened migration 408_structured_session_handoffs.sql
...
-- flattened migration 409_remove_digest_config.sql
...
-- flattened migration 410_normalize_session_feedback_constraints.sql
...
-- flattened migration 411_terminals.sql
...
-- flattened migration 412_mcp_templates_project_secrets.sql
...
-- flattened migration 413_session_feedback_review.sql
...
-- flattened migration 414_sessions_workspace_path.sql
...
-- flattened migration 415_sessions_startup_claim_generation.sql
...
-- flattened migration 416_hook_receipt_effects.sql
...
-- flattened migration 417_provider_capacity_snapshots.sql
...
-- flattened migration 418_project_checkouts.sql
