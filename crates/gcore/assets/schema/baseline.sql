...
-- baseline@420: canonical pg_dump of baseline@419.
...
CREATE TABLE embedding_generation_acks (
...
CREATE TABLE embedding_projection_changes (
...
ALTER TABLE embedding_projection_changes ALTER COLUMN sequence ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME embedding_projection_changes_sequence_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE hook_receipt_effects (
...
ALTER TABLE ONLY agent_step_workflows
...
ALTER TABLE ONLY chat_attachment_cleanup_fences
...
ALTER TABLE ONLY definition_revisions
    ADD CONSTRAINT definition_revisions_pkey PRIMARY KEY (domain);

ALTER TABLE ONLY deployment_runtime
...
ALTER TABLE ONLY embedding_generation_acks
    ADD CONSTRAINT embedding_generation_acks_pkey PRIMARY KEY (daemon_instance_id);

ALTER TABLE ONLY embedding_projection_changes
...
ALTER TABLE ONLY hook_receipt_effects
...
ALTER TABLE ONLY mcp_server_templates
...
ALTER TABLE ONLY provider_capacity_snapshots
...
ALTER TABLE ONLY task_close_reviews
...
CREATE INDEX hook_force_continue_budgets_updated_at_idx ON hook_force_continue_budgets USING btree (updated_at);

CREATE INDEX hook_receipt_effects_current_envelope_idx ON hook_receipt_effects USING btree (current_envelope_id);

CREATE INDEX hook_receipt_effects_session_id_idx ON hook_receipt_effects USING btree (session_id);

CREATE INDEX hook_receipt_effects_state_transition_idx ON hook_receipt_effects USING btree (state, transition_at);

CREATE INDEX idx_agent_defs_project ON agent_definitions USING btree (project_id);
...
CREATE INDEX idx_asi_step_workflow ON agent_step_instances USING btree (agent_step_workflow_id);
...
CREATE INDEX idx_chat_attachments_claim ON chat_attachments USING btree (claim_token, claimed_at) WHERE (claim_token IS NOT NULL);
...
CREATE INDEX idx_chat_attachments_unpublished ON chat_attachments USING btree (created_at) WHERE (published IS FALSE);
...
CREATE UNIQUE INDEX idx_mcp_server_templates_name_project ON mcp_server_templates USING btree (name, project_id);
...
CREATE INDEX idx_mcp_servers_template_id ON mcp_servers USING btree (template_id);
...
CREATE INDEX idx_pipeline_defs_project ON pipeline_definitions USING btree (project_id);
...
CREATE INDEX idx_rule_defs_event ON rule_definitions USING btree (((definition_json ->> 'event'::text))) WHERE (deleted_at IS NULL);

CREATE INDEX idx_rule_defs_project ON rule_definitions USING btree (project_id);
...
CREATE UNIQUE INDEX idx_secrets_name_project ON secrets USING btree (name, project_id);

CREATE INDEX idx_session_feedback_review_run ON session_feedback USING btree (review_run_id) WHERE (review_run_id IS NOT NULL);
...
CREATE INDEX idx_session_var_defs_project ON session_variable_defaults USING btree (project_id);
...
CREATE INDEX idx_task_close_reviews_recovery ON task_close_reviews USING btree (status, delivered_at, updated_at);
...
CREATE INDEX idx_terminals_live ON terminals USING btree (state) WHERE (state = ANY (ARRAY['pending'::text, 'live'::text]));

CREATE UNIQUE INDEX idx_terminals_locator_key_active ON terminals USING btree (locator_key) WHERE ((locator_key IS NOT NULL) AND (state = ANY (ARRAY['pending'::text, 'live'::text])));

CREATE INDEX idx_terminals_machine ON terminals USING btree (machine_id);

CREATE INDEX idx_terminals_project ON terminals USING btree (project_id);

CREATE INDEX idx_terminals_run ON terminals USING btree (agent_run_id) WHERE (agent_run_id IS NOT NULL);

CREATE UNIQUE INDEX idx_terminals_spawn_key ON terminals USING btree (spawn_key) WHERE (spawn_key IS NOT NULL);
...
CREATE UNIQUE INDEX uq_agent_defs_live_name ON agent_definitions USING btree (name, project_id) NULLS NOT DISTINCT WHERE (deleted_at IS NULL);

CREATE UNIQUE INDEX uq_pipeline_defs_live_name ON pipeline_definitions USING btree (name, project_id) NULLS NOT DISTINCT WHERE (deleted_at IS NULL);

CREATE UNIQUE INDEX uq_rule_defs_live_name ON rule_definitions USING btree (name, project_id) NULLS NOT DISTINCT WHERE (deleted_at IS NULL);

CREATE UNIQUE INDEX uq_session_var_defs_live_name ON session_variable_defaults USING btree (name, project_id) NULLS NOT DISTINCT WHERE (deleted_at IS NULL);

CREATE UNIQUE INDEX uq_task_close_reviews_active_task ON task_close_reviews USING btree (task_id) WHERE (status = ANY (ARRAY['launching'::text, 'running'::text, 'finalizing'::text]));

CREATE UNIQUE INDEX uq_task_close_reviews_agent_run ON task_close_reviews USING btree (agent_run_id) WHERE (agent_run_id IS NOT NULL);
...
ALTER TABLE ONLY agent_definitions
    ADD CONSTRAINT agent_definitions_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE DEFERRABLE;
...
ALTER TABLE ONLY agent_step_instances
    ADD CONSTRAINT agent_step_instances_agent_step_workflow_id_fkey FOREIGN KEY (agent_step_workflow_id) REFERENCES agent_step_workflows(id) ON DELETE SET NULL;

ALTER TABLE ONLY agent_step_instances
    ADD CONSTRAINT agent_step_instances_session_id_fkey FOREIGN KEY (session_id) REFERENCES sessions(id) ON DELETE CASCADE DEFERRABLE;

ALTER TABLE ONLY agent_step_workflows
    ADD CONSTRAINT agent_step_workflows_agent_definition_id_fkey FOREIGN KEY (agent_definition_id) REFERENCES agent_definitions(id) ON DELETE CASCADE DEFERRABLE;
...
ALTER TABLE ONLY clones
    ADD CONSTRAINT clones_agent_session_id_machine_id_fkey FOREIGN KEY (agent_session_id, machine_id) REFERENCES sessions(id, machine_id) ON DELETE SET NULL (agent_session_id) DEFERRABLE;
...
ALTER TABLE ONLY mcp_server_templates
    ADD CONSTRAINT mcp_server_templates_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;

ALTER TABLE ONLY mcp_servers
    ADD CONSTRAINT mcp_servers_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE DEFERRABLE;

ALTER TABLE ONLY mcp_servers
    ADD CONSTRAINT mcp_servers_template_id_fkey FOREIGN KEY (template_id) REFERENCES mcp_server_templates(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY memories
    ADD CONSTRAINT memories_source_task_id_fkey FOREIGN KEY (source_task_id) REFERENCES tasks(id) ON DELETE SET NULL DEFERRABLE;
...
ALTER TABLE ONLY pipeline_definitions
    ADD CONSTRAINT pipeline_definitions_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE DEFERRABLE;
...
ALTER TABLE ONLY provider_capacity_snapshots
    ADD CONSTRAINT provider_capacity_snapshots_machine_id_fkey FOREIGN KEY (machine_id) REFERENCES machines(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY rule_definitions
    ADD CONSTRAINT rule_definitions_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE DEFERRABLE;

ALTER TABLE ONLY secrets
    ADD CONSTRAINT secrets_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;

ALTER TABLE ONLY session_feedback
    ADD CONSTRAINT session_feedback_review_run_id_fkey FOREIGN KEY (review_run_id) REFERENCES feedback_review_runs(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY session_variable_defaults
    ADD CONSTRAINT session_variable_defaults_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE DEFERRABLE;
...
ALTER TABLE ONLY terminals
    ADD CONSTRAINT terminals_agent_run_id_fkey FOREIGN KEY (agent_run_id) REFERENCES agent_runs(id) ON DELETE SET NULL DEFERRABLE;

ALTER TABLE ONLY terminals
    ADD CONSTRAINT terminals_machine_id_fkey FOREIGN KEY (machine_id) REFERENCES machines(id);

ALTER TABLE ONLY terminals
    ADD CONSTRAINT terminals_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id);

ALTER TABLE ONLY terminals
    ADD CONSTRAINT terminals_session_id_fkey FOREIGN KEY (session_id) REFERENCES sessions(id) ON DELETE SET NULL DEFERRABLE;
...
ALTER TABLE ONLY worktrees
    ADD CONSTRAINT worktrees_agent_session_id_machine_id_fkey FOREIGN KEY (agent_session_id, machine_id) REFERENCES sessions(id, machine_id) ON DELETE SET NULL (agent_session_id) DEFERRABLE;
...
CREATE POLICY gobby_daemon_runtime_access ON project_checkouts TO gobby_daemon_runtime USING (true) WITH CHECK (true);
...
CREATE POLICY gobby_migration_owner_access ON project_checkouts TO CURRENT_USER USING (true) WITH CHECK (true);
...
GRANT SELECT(machine_id) ON TABLE agent_runs TO gobby_agent_issuer;

GRANT SELECT(status) ON TABLE agent_runs TO gobby_agent_issuer;

GRANT SELECT(worktree_id) ON TABLE agent_runs TO gobby_agent_issuer;

GRANT SELECT(clone_id) ON TABLE agent_runs TO gobby_agent_issuer;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE chat_attachment_cleanup_fences TO gobby_daemon_runtime;
...
GRANT SELECT(id) ON TABLE clones TO gobby_agent_issuer;

GRANT SELECT(project_id) ON TABLE clones TO gobby_agent_issuer;

GRANT SELECT(machine_id) ON TABLE clones TO gobby_agent_issuer;

GRANT SELECT(clone_path) ON TABLE clones TO gobby_agent_issuer;
...
GRANT SELECT(id) ON TABLE config_state TO gobby_gcode_capability;

GRANT SELECT(revision) ON TABLE config_state TO gobby_gcode_capability;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE deployment_runtime TO gobby_daemon_runtime;
...
GRANT ALL ON SEQUENCE embedding_projection_changes_sequence_seq TO gobby_daemon_runtime;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE hook_receipt_effects TO gobby_daemon_runtime;
...
GRANT SELECT(machine_id),UPDATE(machine_id) ON TABLE project_checkouts TO gobby_gcode_capability;

GRANT SELECT(project_id),UPDATE(project_id) ON TABLE project_checkouts TO gobby_gcode_capability;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE provider_capacity_snapshots TO gobby_daemon_runtime;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE task_close_reviews TO gobby_daemon_runtime;
...
GRANT SELECT(id) ON TABLE worktrees TO gobby_agent_issuer;

GRANT SELECT(project_id) ON TABLE worktrees TO gobby_agent_issuer;

GRANT SELECT(machine_id) ON TABLE worktrees TO gobby_agent_issuer;

GRANT SELECT(worktree_path) ON TABLE worktrees TO gobby_agent_issuer;
